  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
      ...
      <Swiper
        ...
        className="w-full py-2 partner-swiper"
      >
        {[...brands, ...brands].map((brand, index) => (
          <SwiperSlide key={index}>
            <div 
              className="flex flex-col items-center justify-center p-5 rounded-xl border border-gray-100 hover:shadow-md hover:border-primary/20 transition-all text-center cursor-pointer group bg-gradient-to-br from-white to-gray-50/30 h-full select-none"
            >
